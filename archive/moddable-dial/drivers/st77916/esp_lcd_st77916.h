...
/*
 * Build glue for the Moddable (non-CMake) build. Upstream injects these
 * version macros via the component's CMakeLists; since we compile the vendored
 * source directly, define them here. Cosmetic (used only in an ESP_LOGI line).
 */
