...
static lv_obj_t *s_row_boost_heat, *s_row_boost_cool, *s_row_match, *s_row_bed_off, *s_row_away;
static lv_obj_t *s_lbl_boost_heat, *s_lbl_boost_cool, *s_lbl_match, *s_lbl_bed_off, *s_lbl_away;
...
static void apply_palette(void)
{
    ...
    lv_obj_t *labels[] = { s_lbl_boost_heat, s_lbl_boost_cool, s_lbl_match, s_lbl_bed_off, s_lbl_away };
...
static void destroy(void)
{
    ...
    s_row_boost_heat = s_row_boost_cool = s_row_match = s_row_bed_off = s_row_away = NULL;
    s_lbl_boost_heat = s_lbl_boost_cool = s_lbl_match = s_lbl_bed_off = s_lbl_away = NULL;
}
